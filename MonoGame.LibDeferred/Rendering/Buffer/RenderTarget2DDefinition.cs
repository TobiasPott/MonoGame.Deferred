...
namespace DeferredEngine.Rendering
{
    ...
    public struct RenderTarget2DDefinition
    {
        ...
        public static readonly RenderTarget2DDefinition SSFx_AO_Main = new RenderTarget2DDefinition(false, SurfaceFormat.Color, DepthFormat.None, 0, RenderTargetUsage.DiscardContents, ResamplingModes.Downsample_x1);
